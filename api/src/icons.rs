...
pub fn icon_nervous(_args: &HashMap<String, Value>) -> Result<Value, Error> {
    Ok(to_value(r#"
    <svg viewBox="0 0 64 64" class="svg-icon icon-nervous">
        <path class="opt" d="M32,1.8C15.3,1.8,1.8,15.3,1.8,32S15.3,62.3,32,62.3S62.3,48.7,62.3,32S48.7,1.8,32,1.8z M32,57.8
            C17.8,57.8,6.3,46.2,6.3,32C6.3,17.8,17.8,6.3,32,6.3c14.2,0,25.8,11.6,25.8,25.8C57.8,46.2,46.2,57.8,32,57.8z"/>
        <path d="M22.1,29.6c4.5,0,8.2-3.7,8.2-8.2c0-1.2-1-2.3-2.3-2.3s-2.3,1-2.3,2.3c0,2.1-1.7,3.7-3.7,3.7s-3.7-1.7-3.7-3.7
            c0-1.2-1-2.3-2.3-2.3s-2.3,1-2.3,2.3C13.8,25.9,17.5,29.6,22.1,29.6z"/>
        <path d="M47.9,19.1c-1.2,0-2.3,1-2.3,2.3c0,2.1-1.7,3.7-3.7,3.7c-2,0-3.7-1.7-3.7-3.7c0-1.2-1-2.3-2.3-2.3s-2.3,1-2.3,2.3
            c0,4.5,3.7,8.2,8.2,8.2c4.5,0,8.2-3.7,8.2-8.2C50.2,20.1,49.2,19.1,47.9,19.1z"/>
        <path d="M46.7,41.5L44,39.8c-2.4-1.4-5.3-1.4-7.7,0c0,0,0,0,0,0c-0.9,0.5-2.1,0.5-3,0c0,0,0,0,0,0c-2.4-1.4-5.3-1.4-7.7,0
            c-1,0.6-2.1,0.6-3.1,0l-2.7-1.6c-1.1-0.6-2.4-0.3-3.1,0.8c-0.6,1.1-0.3,2.4,0.8,3.1l2.7,1.6c2.4,1.4,5.3,1.4,7.7,0
            c0.9-0.6,2.1-0.6,3.1,0c0,0,0,0,0,0c2.4,1.4,5.3,1.4,7.7,0c0,0,0,0,0,0c0.9-0.6,2.1-0.5,3.1,0l2.7,1.6c0.4,0.2,0.8,0.3,1.2,0.3
            c0.8,0,1.5-0.4,1.9-1.1C48.1,43.5,47.7,42.1,46.7,41.5z"/>
    </svg>"#.to_string())?)
}

pub fn icon_exclamation(_args: &HashMap<String, Value>) -> Result<Value, Error> {
    Ok(to_value(r#"
    <svg viewBox="0 0 64 64" class="svg-icon icon-exclamation">
        <path class="opt" d="M55.2,24.9C55.2,12.1,44.8,1.8,32,1.8C19.2,1.8,8.8,12.1,8.8,24.9c0,8.6,4.8,16.5,12.3,20.5v10.7c0,3.4,2.7,6.1,6.1,6.1
            h9.5c3.4,0,6.1-2.7,6.1-6.1V45.4C50.4,41.4,55.2,33.5,55.2,24.9z M38.4,56.1c0,0.9-0.7,1.6-1.6,1.6h-9.5c-0.9,0-1.6-0.7-1.6-1.6
            v-9.9h12.7V56.1z M40.1,41.8H23.9c-6.4-3.1-10.6-9.7-10.6-16.8c0-10.3,8.4-18.7,18.7-18.7s18.7,8.4,18.7,18.7
            C50.7,32.1,46.5,38.7,40.1,41.8z"/>
        <path d="M32,10.4c-1.2,0-2.3,1-2.3,2.3v13.5c0,1.2,1,2.3,2.3,2.3c1.2,0,2.3-1,2.3-2.3V12.6C34.3,11.4,33.2,10.4,32,10.4z"/>
        <path d="M32,31.4c-1.2,0-2.3,1-2.3,2.3v0.5c0,1.2,1,2.3,2.3,2.3c1.2,0,2.3-1,2.3-2.3v-0.5C34.3,32.4,33.2,31.4,32,31.4z"/>
    </svg>"#.to_string())?)
}

pub fn icon_invitation(_args: &HashMap<String, Value>) -> Result<Value, Error> {
    Ok(to_value(r#"
    <svg viewBox="0 0 64 64" class="svg-icon icon-invitation">
        <path class="opt" d="M40.7,27.7c-1.6-1.1-3.3-1.5-5-1.1c-1.5,0.4-2.7,1.3-3.7,2.2c-0.9-0.9-2.2-1.8-3.7-2.2c-1.7-0.4-3.4,0-5,1.1
            c-4.6,3.2-3.3,9.2-1.9,11.9c0.1,0.3,3.5,7.1,10,9.2c0.2,0.1,0.5,0.1,0.7,0.1s0.5,0,0.7-0.1c6.6-2.1,9.7-8.9,9.8-9.2
            C44,36.9,45.3,30.9,40.7,27.7z M38.6,37.6c0,0.1-2.3,4.8-6.5,6.6c-4.2-1.8-6.6-6.6-6.7-6.6c0,0-2.1-4.4,0.5-6.2
            c0.5-0.3,0.8-0.4,1.1-0.4c0.1,0,0.2,0,0.3,0c1.1,0.3,2.3,1.9,2.7,2.6c0.4,0.7,1.2,1.2,2,1.2c0,0,0,0,0,0c0.8,0,1.6-0.5,2-1.2
            c0.4-0.7,1.6-2.3,2.7-2.6c0.3-0.1,0.7-0.1,1.4,0.4C40.7,33.2,38.6,37.5,38.6,37.6z"/>
        <path d="M48,9.4h-0.3V7.6c0-1.8-0.8-3.5-2.3-4.6c-1.4-1.1-3.3-1.5-5-1L11.9,9.5c-0.3,0.1-0.5,0.2-0.8,0.3c-0.1,0.1-0.3,0.2-0.4,0.3
            c-0.4,0.4-0.6,0.9-0.6,1.5c0,0,0,0,0,0c0,0,0,0,0,0c0,0,0,0,0,0c0,0,0,0,0,0v44.7c0,3.2,2.6,5.8,5.8,5.8H48c3.2,0,5.8-2.6,5.8-5.8
            V15.3C53.8,12.1,51.2,9.4,48,9.4z M41.5,6.3c0.5-0.1,1,0.1,1.1,0.2c0.2,0.1,0.5,0.5,0.5,1.1v1.9H29.7L41.5,6.3z M49.3,56.4
            c0,0.7-0.6,1.3-1.3,1.3H16c-0.7,0-1.3-0.6-1.3-1.3V13.9H48c0.7,0,1.3,0.6,1.3,1.3V56.4z"/>
    </svg>
